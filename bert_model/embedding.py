...
class TokenEmbedding(nn.Module):
    def __init__(self):
        ...
        self.token_embedding0 = nn.Embedding(args.vocab_size, args.embedding_size)
        self.token_embedding1 = nn.Linear(args.embedding_size, args.hidden_size)
    ...
    def forward(self, input_ids, type_ids=None):  # (batch, sen)
        ...
        token_embedding0 = self.token_embedding0(input_ids)
        token_embedding = self.token_embedding1(token_embedding0)
